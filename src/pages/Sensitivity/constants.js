...
export const sensitivityChartRows = [
  { id: "minus20", label: "-20%", scenario1: 10.08, scenario2: 14.08704 },
  { id: "base", label: "Precio base", scenario1: 12.6, scenario2: 17.6088 },
  { id: "plus20", label: "+20%", scenario1: 15.12, scenario2: 21.13056 }
];

export const chartBars = [
  ["scenario1", "bg-agro-700"],
  ["scenario2", "bg-violet-500"]
];
...
export const baselineSensitivityRows = [
  { id: "minus20", cells: ["-20%", "$10.080.000", "$14.087.040"] },
  { id: "base", cells: ["Precio base", "$12.600.000", "$17.608.800"] },
  { id: "plus20", cells: ["+20%", "$15.120.000", "$21.130.560"] }
];
